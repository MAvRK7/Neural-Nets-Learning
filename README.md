...
Order:
1. NN: Basic intro about Neural Networks, slope (gradient) calc using differentiation (manual). Pytorch intro- Micrograd
https://www.youtube.com/watch?v=VMj-3S1tku0&list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ
2. Makemore: initial char lvl name predictor. Bigram, uses 2d lookup to index from. Incl Broadcasting, logits, counts, probs
https://www.youtube.com/watch?v=PaCmpygFfXo&list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ&index=2
3. Makemore2: Implementatn of Bengio et al. Hidden layer intro, softmax, learning rate, similar vector emb
https://www.youtube.com/watch?v=TCH_1BHY58I&list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ&index=3
4. Makemore3: Maker deeper nets stable, BatchNorm, torch.Linear, activatn layers
https://www.youtube.com/watch?v=P6sfmUTpUmc&list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ&index=4
5. BackPropPro: Full process, full manual back prop
...
9. GPT-2: Loading it, optimizing (faster, approx, flash attentn, nice nums, algo, more cores (DDP), dataset+, "chat")
